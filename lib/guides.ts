    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'ClearDisk uses Trash-first removal by default and asks for confirmation. This gives you a chance to review the outcome before permanent deletion. The current downloadable app is a 0.1.0 preview; the planned 1.0 cleanup license costs $10 once.',
        ],
      },
      {
        id: 'check-the-result',
