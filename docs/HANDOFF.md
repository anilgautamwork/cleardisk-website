...
App 1.0.0 (build 6): `Sources/Core/License.swift` (key normalization, receipt verification), `Sources/ClearDiskApp/License.swift` (store, client, machine id, license file at `~/Library/Application Support/ClearDisk/license.json`), `UnlockSheet.swift`, gate inside `RemovalConfirmationSheet`, License… menu, `cleardisk://activate?key=` URL scheme. DMG sha256 `242e8a38649c2e2f6f63a3e2ebfd89b93bb2b0c984a8c831c9cb89b14829a174`, 3,061,506 bytes, GitHub release v1.0.0. Follow-ups: onboard `cleardisk.app` to Email Sending; consider embedded Checkout only after measuring created-vs-completed sessions.
